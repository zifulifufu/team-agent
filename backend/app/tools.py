...
EXAMPLE_SKILLS: dict[str, dict] = {
    ...
    "代码评审清单": {
        "description": "评审代码时按顺序检查的清单", "scope": "member",
        "body": "评审代码时按这个顺序看:\n"
    ...
    "调研报告规范": {
        "description": "调研类输出的结构与证据要求", "scope": "member",
        "body": "写调研结果时:\n"
                "1. 开头一句话给结论与建议;\n"
    ...
    "数据分析规范": {
        "description": "数据结论的口径、计算与局限说明", "scope": "member",
        "body": "给数据结论时:\n"
    ...
    "中英互译规范": {
        "description": "中英互译的语气与术语一致性要求", "scope": "member",
        "body": "做中英互译时:\n"
    ...
    "研究报告结构": {
        "description": "正式研究报告 / 论文的章节骨架", "scope": "member",
        "body": "写正式研究报告或论文时按这个骨架:\n"
    ...
    "风险自查清单": {
        "description": "对外发布或对外合作前的合规与风险自查", "scope": "member",
        "body": "对外发布 / 合作前逐项自查,每项给「有 / 无 / 待确认」和处置建议:\n"
